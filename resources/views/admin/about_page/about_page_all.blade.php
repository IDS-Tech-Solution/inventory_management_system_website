                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.page') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea required="" name="short_description" type="text" placeholder="" value="" class="form-control"
                                            rows="5">{{ $aboutpage->short_description }}</textarea>
                                    </div>
                                </div>{{-- end row --}}
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1" name="long_description" value="">{{ $aboutpage->long_description }}</textarea>
                                    </div>
                                </div>{{-- end row --}}
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="file" placeholder="" name="about_image"
                                            id="images" value="{{ $aboutpage->about_image }}">
                                    </div>
                                </div>
                                {{-- end row --}}
                                <div class="row mb-3">
