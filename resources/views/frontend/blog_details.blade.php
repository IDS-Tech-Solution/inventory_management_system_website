...
@section('content')
@section('title')
    Blog Details | Eftay Khyrul Alam
@endsection
<main>
    <!-- breadcrumb-area -->
                        ...
                        <div class="blog__details__content services__details__content">
                            <ul class="blog__post__meta">
                                <li><i class="fal fa-calendar-alt"></i>
                                    {{ Carbon\Carbon::parse($blogDetails->created_at)->diffForHumans() }}</li>
                            </ul>
                            <h2 class="title">{{ $blogDetails->blog_title }}</h2>
                                    ...
                                    <div class="blog__next__prev__item">
                                        ...
                                        <div class="blog__next__prev__post">
                                            ...
                                            <div class="blog__next__prev__content">
                                                <h5 class="title"><a href="blog-details.html">Digital
                                                        Marketing Agency
                                                        Pricing Guide.</a></h5>
                                            </div>
                                        </div>
                    ...
                    <aside class="blog__sidebar">
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__tags">
                                @foreach ($all as $item)
                                    <li><a href="blog.html">{{ $item->blog_tag }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </aside>
